      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" style="background-color: greenyellow;" href="{{url('my_appointment')}}">My Appointment</a>
              </li>
  ...
  <div align="center" style="padding: 70px;">
    ...
    <table>
        ...
        <tr style="background-color: black" align='center'>
            ...
            <td>
                <a onclick="return confirm('Are you sure to delete this')" class="btn btn-danger" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a>
            </td>
        </tr>
        @endforeach
